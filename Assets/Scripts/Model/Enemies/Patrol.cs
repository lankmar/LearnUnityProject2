...
namespace BerserkAdventure
{
	public class Patrol
	{
        ...
        public void GenericPoint(NavMeshAgent agent,  Vector3 currentPoint, bool isRandom = true)
        {
            if (!agent) return;
        ...
        public void NextDestinationPoint(NavMeshAgent agent, bool isRandom = true)
		{ }
	}
}